...
//            if(rs1.next()){
//                 JOptionPane.showMessageDialog(null,"This roll number is already enterd results");
//                   setVisible(false);
//                 new addResult().setVisible(true);
//            } 
           ...
           if(rs.next()){
               st.executeUpdate("insert into result(rollno,physics,maths,em,os,dbms) values('"+roll+"','"+physics+"','"+maths+"','"+em+"','"+os+"','"+dbms+"')");
           JOptionPane.showMessageDialog(null,"Marks saved successfully");
           setVisible(false);
           new addResult().setVisible(true);
           }
           else {
               JOptionPane.showMessageDialog(null,"This roll number is not  registerd");
           }
